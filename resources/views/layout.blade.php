...
<body
                ...
                <div class="c-navbar-wrapper clearfix">
                    ...
                    <nav
                        ...
                        <ul class="nav navbar-nav c-theme-nav">
                            ...
                            <li class="c-menu-type-classic">
                                <a rel="" href="{{ route('video-highlight') }}"
                                    class="c-link dropdown-toggle ">Video<span class="c-arrow c-toggler"></span></a>
                            </li>
                            <li><a href="/login"
        ...
        <div class="c-content-box">
            <div id="slider" class="owl-theme section section-cate slideshow_full_width ">
                <div id="slide_banner" class="owl-carousel">
                    @foreach ($slider as $key => $huySlider)
                        <div class="item">
                            <a href="/" alt="{{ $huySlider->title }}">
                                <img src="{{ $huySlider->image }}" height="300px" width="100%"
                                    alt="{{ $huySlider->title }}">
                            </a>
                        </div>
                    @endforeach
    ...
    <script>
        function video_highlight($id) {
            // var video_id = $('.video_click').data('video');
            // alert($id);
