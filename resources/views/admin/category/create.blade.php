                    ...
                    <div class="pt-4">
                        <form method="post" enctype="multipart/form-data" action="{{ route('category.store') }}">
                            ...
                            <div class="form-group">
                                <label>Title</label>
                                <input type="text" name="title" id="slug" onkeyup="ChangeToSlug()" class="form-control" placeholder="...">
                            </div>
                            <div class="form-group">
                                <label>Slug</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="decs" id="" cols="30" rows="10" placeholder="..." class="form-control"></textarea>
                            </div>
