                ...
                <div class="row">
                    <div class="alert alert-info" role="alert">
                        ...
                        <p><span style="color:#e74c3c"><strong>{{ $category->title }} .
                                </strong></span><strong>{{ $category->decs }}</strong></p>
                        <p></p>
                    </div>
                        ...
                        <div class="m-l-10 m-r-10">
                            <form class="form-inline m-b-10" role="form" method="get" data-hs-cf-bound="true">
                                ...
                                <div class="col-md-3 col-sm-4 p-5 no-radius">
                                    ...
                                    <a class="btn c-square m-l-0 btn-danger" href="https://nick.vn/garena/lien-quan">Tất
                                        cả</a>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="c-content-client-logos-slider-1  c-bordered" data-slider="owl">
                        ...
                        <div class="row row-flex  item-list">
                            @foreach ($nick as $key => $huyAcc)
                                <div class="col-sm-6 col-md-3">
                                    <div class="classWithPad">
                                        <div class="image">
                                            <a href="#">
                                                <img src="{{ $huyAcc->image }}" alt="png-image">
                                                <span class="ms">MS: {{ $huyAcc->ms }}</span>
                                            </a>
                                        </div>
                                        ...
                                        <div class="attribute_info">
                                            <div class="row">
                                                @php
                                                    $attribute = json_decode($huyAcc->attribute, true);
                                                @endphp
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6">
                                                    <div class="price_item">
                                                        {{ number_format($huyAcc->price) }} VND
                                                    </div>
                                                </div>
                                                <div class="col-xs-6 ">
                                                    <div class="view">
                                                        <a href="{{ route('acc', $huyAcc->ms) }}">Chi tiết</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
