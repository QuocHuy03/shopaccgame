        ...
        <div class="c-content-box c-size-md">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="art-list">
                            @foreach ($blogs as $key => $huyBlogs)
                                <div class="a-item">
                                    <div class="thumbnail-image img-thumbnail"><a
                                            href="{{ route('blogs_detail', $huyBlogs->slug) }}"><img
                                                src="{{ $huyBlogs->image }}" alt="png-image"></a></div>
                                    <div class="info">
                                        <div class="article_title ">
                                            <h2><a href="{{ route('blogs_detail', $huyBlogs->slug) }}"
                                                    style="text-transform: initial;">{{ $huyBlogs->title }}</a></h2>
                                        </div>
                                        ...
                                        <div class="article_description hidden-xs"></div>{!! $huyBlogs->description !!}
                                    </div>
                                </div>
                        </div>
                        @endforeach
