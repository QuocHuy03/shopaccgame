...
@section('content')
    <div class="c-content-box c-size-lg c-overflow-hide c-bg-white">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 visible-sm visible-xs visible-sm">
                        <div class="text-center m-t-20">
                            <img class="img-responsive img-thumbnail" src="{{ $nick->image }}" alt="png-image">
                        </div>
        ...
        <div class="container m-t-20 content_post">
            ...
            <p>
                <a rel="gallery1" data-fancybox="images" href="{{ asset('upload/gallery/' . $gal->image) }}">
                    <img class="img-responsive img-thumbnail" src="{{ asset('upload/gallery/' . $gal->image) }}" alt="png-image">
                </a>
            </p>                
            @endforeach
