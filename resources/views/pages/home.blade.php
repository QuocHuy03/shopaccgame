        ...
        <div class="container">
            ...
            <div class="c-content-client-logos-slider-1  c-bordered" data-slider="owl">
                ...
                <div class="row row-flex-safari game-list">
                    @foreach ($category as $key => $showDanhMuc)
                        <div class="col-sm-3 col-xs-6 p-5">
                            <div class="classWithPad">
                                <div class="news_image">
                                    ...
                                    <a href="{{ route('danhmucgame', $showDanhMuc->slug) }}" title="{{ $showDanhMuc->title }}"
                                        class="">
                                        <img src="{{ $showDanhMuc->image }}" alt="{{ $showDanhMuc->title }}"></a>
                                </div>
                                <div class="news_title">
                                    <h2>
                                        <a href="{{ route('danhmucgame', $showDanhMuc->slug) }}"
                                            title="Danh Mục Game Liên Quân">{{ $showDanhMuc->title }}</a>
                                    </h2>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="custom72 view">
                                                <a href="#" class="" title="{{ $showDanhMuc->title }}">
                                                    &nbsp;
                                                    <style type="text/css">
                                                        .custom72 {
