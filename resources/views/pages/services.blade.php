            ...
            <div class="container">
                <div class="row">
                    <div class="alert alert-info" role="alert">
                        <h2 class="alert-heading">Dịch Vụ Game Liên Quân</h2>
                        <p></p>
                        <p><span style="color:#e74c3c"><strong>Dịch Vụ Game Liên Quân . </strong></span><strong>Dịch vụ
                        ...
                        <div class="col-sm-3 col-xs-6 p-5">
                            <div class="classWithPad">
                                ...
                                <div class="news_title">
                                    <h2>
                                        <a href="{{route('dichvucon','cay-thue-lien-quan')}}" title="Danh Mục Game Liên Quân">Danh Mục
                                            Game Liên Quân</a>
                                    </h2>
                                </div>
